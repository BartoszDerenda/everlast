...
class Dwarf(Character):
    ...
    strength_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    intelligence_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    endurance_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    speed_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    agility_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    willpower_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    charisma_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
    luck_multiplier = models.DecimalField(max_digits=4, decimal_places=2, default=1.0)
